...
def filterText(update, context):
    ...
    if start != -1:
        ...
        context.bot.send_message(chat_id=update.message.chat_id,reply_to_message_id=update.message.message_id, text="🔥 *APORTE DE* "+sender+" ➡️ "+newReferURL(pCode),parse_mode=ParseMode.MARKDOWN)
